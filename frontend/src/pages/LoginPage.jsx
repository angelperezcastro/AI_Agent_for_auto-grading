    ...
    <main className="auth-premium-bg relative min-h-screen overflow-hidden px-4 py-8 text-white sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl items-center justify-center">
        <section className="auth-card-enter grid w-full overflow-hidden rounded-[2rem] border border-white/15 bg-white/[0.08] p-4 shadow-2xl shadow-slate-950/50 backdrop-blur-2xl sm:p-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-6">
          <div className="auth-form-card-enter rounded-[1.5rem] border border-white/15 bg-slate-950/55 p-6 shadow-2xl shadow-slate-950/40 backdrop-blur-xl sm:p-8 lg:min-h-[600px]">
            <div className="mb-8">
          ...
          <aside className="hidden rounded-[1.5rem] border border-white/10 bg-slate-950/35 p-8 shadow-2xl shadow-slate-950/30 backdrop-blur-xl lg:flex lg:min-h-[600px] lg:flex-col lg:justify-between">
            <div>
              ...
              <h2 className="max-w-xl text-5xl font-bold tracking-tight text-white">
                Submit work, receive feedback, and keep the professor in the
                loop.
              </h2>

              <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">
                A clean preview of the SE Autograder process: students submit
                deliverables, the AI reviews them, feedback is generated, and
                professors can override scores when needed.
              </p>
            </div>
            ...
            <div className="mt-8">
              <ProcessFlowPreview
                ...
                subtitle="Decorative simulation of the core grading process."
              />
            </div>
          </aside>
        </section>
